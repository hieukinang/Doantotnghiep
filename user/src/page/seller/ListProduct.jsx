      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 bg-white rounded-lg shadow p-4">
          ...
          <form className="grid grid-cols-1 gap-3">
            ...
            <button
              type="button"
              className="bg-[#116AD1] text-white rounded px-4 py-2 hover:bg-[#0e57aa]"
            >
              Thêm
            </button>
          </form>
                    ...
                    <td className="px-4 py-2">
                      <div className="flex justify-end gap-2">
                        <Link
                          ...
                          className="px-3 py-1 border rounded text-[#116AD1] border-[#116AD1]"
                        >
                          Sửa
                        </Link>
                        <button className="px-3 py-1 border rounded text-red-600 border-red-300">
                          Xóa
                        </button>
                      </div>
                    </td>
