...
Admin.hasMany(ShippingCode, { foreignKey: "adminId", as: "AdminShippingCodes" });
...
Store.hasMany(Coupon, { foreignKey: "storeId", as: "StoreCoupons" });
Coupon.belongsTo(Store, { foreignKey: "storeId", as: "CouponStore" });
