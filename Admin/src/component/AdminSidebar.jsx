...
//         </button>
//         {isSidebarOpen && (
//           <span className="text-base font-semibold text-gray-700 ml-1 select-none">
//             Bảng điều khiển
//           </span>
//         )}
//       </div>
...
//                 {/* Tooltip khi thu gọn */}
//                 {!isSidebarOpen && (
//                   <div className="absolute left-full top-1/2 transform -translate-y-1/2 ml-2 px-2 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap shadow-lg z-50">
//                     {item.name}
//                   </div>
//                 )}
//               </Link>
